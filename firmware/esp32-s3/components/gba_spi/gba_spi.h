...
extern volatile uint32_t g_reset_wake_count;   /* g_wake_words' value AT the reset — see gba_spi.c */
...
/* docs/26 Phase 0: one-shot post-wake wire capture (raw words + ccount-since-wake deltas) */
#define GBA_PW_N 12
